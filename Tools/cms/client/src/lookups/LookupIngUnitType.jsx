export const LookupIngUnitType = {
    ...
    tbs: { id: 4, description: "Tbsp", shortName: " Tbsp ", shortNamePlural: " Tbsp " },
    cups: { id: 5, description: "Cups", shortName: " cup ", shortNamePlural: " cups " },
    bunch: { id: 6, description: "Bunch", shortName: " bunch of ", shortNamePlural: " bunches of " },
    rashers: { id: 7, description: "Rashers", shortName: " rasher of ", shortNamePlural: " rashes of " },
    head: { id: 8, description: "Head", shortName: " head of ", shortNamePlural: " heads of " },
    sprig: { id: 9, description: "Sprig", shortName: " sprig of ", shortNamePlural: " sprigs of " },
    stalk: { id: 10, description: "Stalk", shortName: " stalk of ", shortNamePlural: " stalks of " },
    sheets: { id: 11, description: "Sheets", shortName: " sheet of ", shortNamePlural: " sheets of " },
    slice: { id: 12, description: "Slice", shortName: " slice of ", shortNamePlural: " slices of " },
